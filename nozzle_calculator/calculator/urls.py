...
urlpatterns = [
    ...
    path('nozzle/calculation/<int:calculation_id>/calculation_details', nozzle_calculation_details_view, name='nozzle_calculation_details'),
    path('nozzle/<int:nozzle_id>/add_calculation', add_nozzle_calculation_view, name='add_nozzle_calculation'),
    path('nozzle/<int:nozzle_id>/add_calculation_confirm', add_nozzle_calculation_confirm_view, name='add_nozzle_calculation_confirm'),
